...
public class DefaultMQPushConsumer extends ClientConfig implements MQPushConsumer {
     ...
     * </ul>
     */
    // 注意消费者组没有对应queue的消费offset的时候才有效
    // 也就是第一次消费的时候才有效
     ...
     */
    // 当consumeFromWhere 设置为 CONSUME_FROM_TIMESTAMP 才有效
     ...
     * Offset Storage
     *
     * 本地消费存储 一般是 RemoteBrokerOffsetStore
     */
     ...
     *
     * 本地消息队列中第一条和最后一条消息 offset跨度不能超过2000
     * 相当于流控
     */
